...
export default function Home() {
  return (
      ...
      //     <Link href="/dashboard" className="flex justify-between gap-1">  <UserPen /> Get Started</Link>
      //   </div>
      //   <hr />
      //   <div className="flex items-center justify-center gap-8 flex-col mt-10 p-3">
      //     <h1 className="font-bold text-4xl">AI Content <span className="text-blue-800"> Generator</span></h1>
      //     <p>Revolutionize your content creation with our AI powered App,delivering engaging and high quality text in seconds</p>
      //     <Link href="/dashboard">
      //       <Button className="font-bold p-5">Get Started</Button></Link>
      //   </div>
      //   <Footer/>
      //  </div>
