export default [
    {
        ...
        aiPrompt:'Give me 5 blog topic idea in bullet wise on give niche & outline and give me result in Rich text editor format',
    ...
    {
        name:'blog Content',
        desc:'An AI tool that serves as your personal blog post title writer,generating catchy and viral-worthy titles in your choosen language. ',
        category:'blog',
    ...
    },
    {
        ...
        aiPrompt:'Generating top 5 blog topic Ideas in bullet point only, (no description) based on niche in rich text editor format',
        form:[
            {
